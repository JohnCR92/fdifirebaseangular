...
@Component({
    ...
    templateUrl:'./centrenamiento-list.component.html',
    styleUrls:[
        './centrenamiento-list.component.css'
    ]
    
})

export class CentrenamientoListComponent{
                ...
                popupWin.document.write(`
                    ...
                    <html>
                      ...
                      <head>
                        ...
                        <title align="rigth">FEDERACIÓN DEPORTIVA</title>

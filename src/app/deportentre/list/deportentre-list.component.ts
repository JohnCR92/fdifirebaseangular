...
@Component({
    ...
    templateUrl: './deportentre-list.component.html',
    styleUrls: [
        './deportentre-list.component.css'
    ]
})

export class DeportEntreListComponent {
    ...
    eliminar(edDeportistaEntrenador: any) {
        this.deportentreService.delete(edDeportistaEntrenador.idDepEntre).subscribe(fdiCategoriaDisciplina => {
            this.alertasService.mostrarAlertaWarning("Actualizando", "Se eliminó el Entrenador con su respectivo Deportista Correctamente!!")
            console.log(this.edDeportistaEntrenador);

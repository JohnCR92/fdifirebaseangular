...
@Component({
    selector: 'entrenadordisci-formedited',
    templateUrl: './entrenadordisci-formedited.component.html',
    styleUrls: ['./entrenadordisci-formedited.component.css']
}

)


export class EntrenadorDisciFormEditedComponent {

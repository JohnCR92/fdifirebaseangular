...
export const routes:Routes = [
  ...
  { path: 'bootstrap-element',
    loadChildren: 'app/+form/+bootstrap-element/bootstrap-element.module#BootstrapElementModule',
    data: {pageTitle: 'Bootstrap Element'}
  },
  ...
  {
    path: 'element',
    loadChildren: 'app/+form/+form-element/form-element.module#FormElementModule',
    data: {pageTitle: 'Element'}
  },
  {
    path: 'layouts',

...
@Component({
    selector:'disciplina-formeditd',
    templateUrl:'./disciplina-formeditd.component.html',
    styleUrls:['./disciplina-formeditd.component.css']
    })
    
    export class DisciplinaFormeditdComponent{

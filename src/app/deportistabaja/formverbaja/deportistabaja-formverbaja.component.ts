...
@Component({
    selector: 'deportistabaja-formverbaja',
    templateUrl: './deportistabaja-formverbaja.component.html',
    styleUrls: ['./deportistabaja-formverbaja.component.css']
}

)


export class DeportistaFormverbajaComponent {
    ...
    print(): void {
        ...
        popupWin.document.write(`
          ...
          <br>
                  ...
                  <body align="center">
                  <body>
                  <b >DATOS DEL DEPORTISTA DADO DE BAJA</b>
                  </body>
                  <br>
                  <body>
                  <b align="center">---------------------------------------------------------------</b>
      ...
      <label for="prsCedula"
          style="color: rgb(126, 123, 123) ; font-family: Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif">
          <FONT SIZE=4>* Dificultad del Deportista: </FONT>
      </label><b>
          <FONT SIZE=3>
          ${this.edDeportista.deportBajaDificultad}
          </FONT>
      </b>
      <br>
      <br>
      ...
      <label for="prsCedula"
          style="color: rgb(126, 123, 123) ; font-family: Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif">
          <FONT SIZE=4>* Tiempo en el Area: </FONT>
      </label><b>
          <FONT SIZE=3>
          ${this.edDeportista.deportBajaTiempoArea}
          </FONT>
      </b>
      <br>
      <br>
      ...
      <label for="prsCedula"
          style="color: rgb(126, 123, 123) ; font-family: Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif">
          <FONT SIZE=4>* Motivo de la Baja del Deportista: </FONT>
      </label><b>
          <FONT SIZE=3>
          ${this.edDeportista.deportBajaMotivoBaja}
          </FONT>
      </b>
      <br>
      <br>
      ...
      <label for="prsCedula"
          style="color: rgb(126, 123, 123) ; font-family: Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif">
          <FONT SIZE=4>* Medidas Tomadas: </FONT>
      </label><b>
          <FONT SIZE=3>
          ${this.edDeportista.deportBajaMedidasTomadas}
          </FONT>
      </b>
      <br>
      <br>
      ...
      <label for="prsCedula"
          style="color: rgb(126, 123, 123) ; font-family: Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif">
          <FONT SIZE=4>* Recomendaciones: </FONT>
      </label><b>
          <FONT SIZE=3>
          ${this.edDeportista.deportBajaRecomendacion}
          </FONT>
      </b>
      ...
      <label for="prsCedula"
          ...
          <FONT SIZE=3>
          ${this.edDeportista.deportBajaObservacion}
          </FONT>
      </b>
      <br>
                      <br>

...
@Component({
    ...
    templateUrl: './deportistabaja-form.component.html',
    styleUrls: ['./deportistabaja-form.component.css']
}

)


export class DeportistabajaFormComponent {
    ...
    public setArchivo(event)
  {
    ...
    private getDB() {
        //console.log(this.nombre);
        this.deportistaService.getDB().subscribe(deportistas => {

...
@Component({
    selector: 'premiosdeportista-formeditp',
    templateUrl: './premiosdeportista-formeditp.component.html',
    styleUrls: ['./premiosdeportista-formeditp.component.css']
}

)


export class PremiosDeportistaFormeditComponent {
